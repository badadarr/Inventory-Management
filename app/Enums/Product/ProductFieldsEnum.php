...
enum ProductFieldsEnum: string implements BaseEnumInterface
{
    ...
    case UKURAN         = 'ukuran'; // nullable
    case UKURAN_POTONGAN_1 = 'ukuran_potongan_1'; // nullable
    case UKURAN_PLANO_1 = 'ukuran_plano_1'; // nullable
    case UKURAN_POTONGAN_2 = 'ukuran_potongan_2'; // nullable
    case UKURAN_PLANO_2 = 'ukuran_plano_2'; // nullable
    ...
    public static function labels(): array
    {
        return [
            ...
            self::UKURAN->value         => "Ukuran",
            self::UKURAN_POTONGAN_1->value => "Ukuran Potongan 1",
            self::UKURAN_PLANO_1->value => "Ukuran Plano 1",
            self::UKURAN_POTONGAN_2->value => "Ukuran Potongan 2",
            self::UKURAN_PLANO_2->value => "Ukuran Plano 2",
