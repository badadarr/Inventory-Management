...
onMounted(() => {
    ...
    // Load existing sizes or create default if none
                        ...
                        <div class="grid gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
                            ...
                            <div class="flex flex-col col-span-3">
                                ...
                                <div class="flex gap-4 items-start">
                                    ...
                                    <div class="flex-1">
                                        <p class="text-xs text-gray-500 mb-1">📷 Click image to change photo</p>
                            ...
                            <div class="flex flex-col">
                                ...
                                <textarea
                                    ...
                                    type="text"
                                    rows="3"
                                    placeholder="Enter keterangan tambahan (optional)"
                                    class="mt-2 block w-full rounded-md border border-gray-200 px-2 py-2 shadow-sm outline-none focus:outline-none focus:shadow-outline"
                                ></textarea>
