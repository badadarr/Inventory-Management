...
onMounted(() => {
    ...
    form.bahan = props.product.bahan;
    form.gramatur = props.product.gramatur;
    form.ukuran = props.product.ukuran;
    form.ukuran_potongan_1 = props.product.ukuran_potongan_1;
    form.ukuran_plano_1 = props.product.ukuran_plano_1;
    form.ukuran_potongan_2 = props.product.ukuran_potongan_2;
    form.ukuran_plano_2 = props.product.ukuran_plano_2;
    form.alamat_pengiriman = props.product.alamat_pengiriman;
