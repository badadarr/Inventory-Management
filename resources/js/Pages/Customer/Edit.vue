...
const previewImage = ref(props.customer.photo || null);

const form = useForm({
    name: props.customer.name,
    email: props.customer.email,
    phone: props.customer.phone,
    nama_box: props.customer.nama_box,
    nama_owner: props.customer.nama_owner,
    sales_id: props.customer.sales_id,
    tanggal_join: props.customer.tanggal_join,
    status_customer: props.customer.status_customer,
    status_komisi: props.customer.status_komisi,
    harga_komisi_standar: props.customer.harga_komisi_standar,
    harga_komisi_extra: props.customer.harga_komisi_extra,
                        ...
                        <div class="flex flex-wrap items-center">
                            <div class="relative w-full px-4 max-w-full flex-grow flex-1">
                                <div class="flex justify-between items-center">
                                    <h4 class="text-2xl font-semibold">Edit Customer</h4>
                                    <Button
