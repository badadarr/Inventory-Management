                ...
                <div class="w-full px-4 flex justify-center">
                    <div class="relative" @mouseenter="isHovered = true" @mouseleave="isHovered = false">
                        ...
                        <div
                            v-if="isHovered"
                            @click="triggerFileInput"
                            class="absolute flex items-center justify-center rounded-full cursor-pointer bg-black bg-opacity-50"
                            style="width: 150px !important; height: 150px !important; top: -64px; left: -80px;"
                        >
...
const handleFileChange = (event) => {
    ...
    if (file) {
        ...
        form.post(route('profile.update.image'), {
            preserveScroll: true,
            onSuccess: () => {
                showToast();
            },
